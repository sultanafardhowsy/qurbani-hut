...
const ExtraSection = () => {
    return (
        <div className='my-4 container mx-auto items-center'>
            <div>
                <h2 className='text-2xl font-bold text-center mb-4'>Qurbani Tips</h2>
            ...
            <h2 className='text-2xl font-bold text-center mt-4 pb-4'>Top breeds</h2>
          <p className='text-center px-2'>
